...
//		User addUser = userDao.save(user);
		...
		String subject = "Shimmer Shop - Verify Your Email Address for User Registration";
		String message = "User Registration OTP for Shimmer Shop: " + otp + ". Please keep it confidential.";
...
//		}
		...
		String subject = "Shimmer Shop - Verify OTP for Forget Password";
		String message = "Forget Password Verificatoion OTP for Shimmer Shop Website: " + otp + ". Please keep it confidential.";
